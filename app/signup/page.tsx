...
export default function SignupPage() {
  ...
  const handleSignup = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      toast({ title: "Account Created!", description: "Welcome to YourSpace! Let's set up your profile." });
    ...
    <div className="container mx-auto flex min-h-[calc(100vh-10rem)] items-center justify-center py-12 px-4">
      <Card className="w-full max-w-md shadow-xl">
        <CardHeader className="text-center">
          ...
          <CardDescription>Join YourSpace and start sharing your creativity.</CardDescription>
        </CardHeader>
        <CardContent>

...
// Note: The user's example used a different set of features. I am using the
// original features from the codebase and adding the new altText property.
      ...
      <div className="flex flex-col max-w-[960px] flex-1">
        ...
        <div className="flex flex-col gap-10 px-4 py-10">
          <div className="flex flex-col gap-4">
            <h1 id="features-heading" className="text-foreground tracking-tight text-[32px] font-bold leading-tight sm:text-4xl max-w-[720px]">
              Core Features
            </h1>
